                ...
                <div class="form-input mt-3">
                    ...
                    <select class="form-control" name="pasien">
                        ...
                        ?>
                            ...
                            ?>
                                <option value="<?php echo $id_pasien2 ?>" <?php echo $selected ?>><?php echo $data['nama'] ?></option>
                        <?php
                            }
                        }
                        ?>
                ...
                <div class="form-input mt-3">
                    ...
                    <select class="form-control" name="dokter">
                        ...
                        ?>
                            ...
                            ?>
                                <option value="<?php echo $id_dokter2 ?>" <?php echo $selected ?>><?php echo $data['nama'] ?></option>
                        <?php
                            }
                        }
                        ?>
