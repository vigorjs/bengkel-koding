                    ...
                    <div class="card-body">
                        <form action="edit.php" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" value="<?= $todo['tgl_awal']; ?>" name="tgl_awal">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword2">Tanggal Akhir</label>
                                <input type="date" class="form-control" value="<?= $todo['tgl_akhir']; ?>" name="tgl_akhir">
                            </div>
